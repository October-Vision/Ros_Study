...
class ADDsumRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ADDsumRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ADDsumRequest
    let len;
    let data = new ADDsumRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ADDsumRequest(null);
...
class ADDsumResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ADDsumResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ADDsumResponse
    let len;
    let data = new ADDsumResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ADDsumResponse(null);
...
module.exports = {
  Request: ADDsumRequest,
  Response: ADDsumResponse,
  md5sum() { return '4781436a0c2affec8025955a6041e481'; },
  datatype() { return 'com_test/ADDsum'; }
};
