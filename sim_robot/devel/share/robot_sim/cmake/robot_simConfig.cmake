...
if("TRUE" STREQUAL "TRUE")
  set(robot_sim_SOURCE_PREFIX /home/wang/ros_study/sim_robot/src/robot_sim)
  set(robot_sim_DEVEL_PREFIX /home/wang/ros_study/sim_robot/devel)
  ...
  set(robot_sim_INSTALL_PREFIX /home/wang/ros_study/sim_robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_sim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wang/ros_study/sim_robot/src/robot_sim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT robot_sim_NUM_DUMMY_TARGETS)
      set(robot_sim_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::robot_sim::wrapped-linker-option${robot_sim_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR robot_sim_NUM_DUMMY_TARGETS "${robot_sim_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::robot_sim::wrapped-linker-option${robot_sim_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND robot_sim_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND robot_sim_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wang/ros_study/sim_robot/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(robot_sim_EXPORTED_TARGETS ${${robot_sim_dep}_EXPORTED_TARGETS})
endforeach()
